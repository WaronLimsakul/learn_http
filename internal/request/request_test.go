...
// we assume that there will be content lenght in the body
func TestBodyParse(t *testing.T) {
	...
	// Test: Body shorter than reported content length (invalid)
	reader = &chunkReader{
		data: "POST /submit HTTP/1.1\r\n" +
			"Host: localhost:42069\r\n" +
			"Content-Length: 20\r\n" +
	...
	// (shouldn't error, we're assuming Content-Length will be present if a body exists)
	reader = &chunkReader{
		data: "POST /submit HTTP/1.1\r\n" +
			"Host: localhost:42069\r\n" +
			"\r\n" +
